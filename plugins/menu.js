...
%m2 *Hari:* %week %weton
%m2 *Tanggal:* %date
%m2 *Tanggal Islami:* %dateIslamic
%m2 *Waktu:* %wib
%m3

%m1 *I N F O*
%m2 *Nama Bot:* *Rull BOT*
%m2 *Mode:* %mode
 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `🗣️ ${pmenus} REQUEST FITUR`, rowId: ".request", description: "Request fitur Rull BOT"},
	]
    },{
	title: `┄┄┄┄┅┅| SUPPORT |┅┅┄┄┄┄`,
	rows: [
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Whyzzxy TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://bit.ly/3eggcxd'
                    }
                },
                {
                    urlButton: {
